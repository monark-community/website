...
<div className="flex">
    ...
    <div className="w-full">
        ...
        [Borrowx](https://borrowx.monark.io) focuses specifically on the borrowing experience within a decentralized lending protocol. Users can view available assets, deposit collateral, select borrowing terms, and initiate loans. The system tracks the user's collateral ratio, repayment schedule, and borrowing interest.

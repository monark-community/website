...
const outputFilePath = path.join(
  process.cwd(),
  `app/[locale]/initiative/project/projects-index.i18n.ts`
);

let fileContent = `// This file is generated by project-index.script.ts. Do not edit manually.
import { DatedProjectMetadata } from "@/types/project.types";`;
...
locales.forEach((locale) => {
  ...
  const previousIndexPath = path.join(
    process.cwd(),
    `app/${locale}/initiative/project/projects.i18n.ts`
  );
  ...
  fileContent += `\nexport const ${locale}: DatedProjectMetadata[] = ${JSON.stringify(
    projectIndex,
    null,
    2
  )};

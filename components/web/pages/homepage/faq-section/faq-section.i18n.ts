    ...
    items: [
      ...
      },
      {
        ...
        <ul>
          ...
          <li><strong><a href="/forms/contact">Share your ideas and feedback</a></strong> with the team</li>
    ...
    items: [
      ...
      // },
      {
        ...
        <ul>
          ...
          <li><strong><a href="/forms/contact">Partager vos idées et vos retours</a></strong> avec l'équipe</li>
